    ...
    always @(*) begin
        if (is_secret) begin
            case (sub_val)
                ...
                3'sb001: coeff_out = 12'd767;  
                3'sb010: coeff_out = 12'd1534; 
                3'sb111: coeff_out = 12'd2562; 
                3'sb110: coeff_out = 12'd1795; 
                default: coeff_out = 12'd0;
            endcase
        end else begin
            case (sub_val)
                3'sb000: coeff_out = 12'd0;    
                3'sb001: coeff_out = 12'd1;    
                3'sb010: coeff_out = 12'd2;    
                3'sb111: coeff_out = 12'd3328; 
                3'sb110: coeff_out = 12'd3327; 
                default: coeff_out = 12'd0;
            endcase
        end
    end
